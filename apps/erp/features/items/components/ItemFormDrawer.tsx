...
export function ItemFormDrawer({ item, onClose }: Props) {
  ...
  useEffect(() => {
    if (item) {
      form.reset({
        ...
        item_parent_category: item.item_perent_category
          ? item.item_perent_category.toString()
          : "",
        ...
        sales_currency_id: item.sales_currency_id
          ? item.sales_currency_id.toString()
          : "",
        ...
        purchase_currency_id: item.purchase_currency_id
          ? item.purchase_currency_id.toString()
          : "",
  ...
  const onSubmit = (values: ItemValues) => {
    ...
    const payload = {
      ...
      item_perent_category: item_parent_category
        ? Number(item_parent_category)
        : null,
      ...
      sales_currency_id: values.sales_currency_id
        ? Number(values.sales_currency_id)
        : null,
      ...
      purchase_currency_id: values.purchase_currency_id
        ? Number(values.purchase_currency_id)
        : null,
    ...
    if (isEdit && item) {
      updateItem(
        {
          id: (item.item_id ?? (item as any).id).toString(),
          body: payload as any,
        },
        { onSuccess: () => onClose() },
      );
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    placeholder="e.g. Industrial Steel Pipe 50mm"
                ...
                <label className="altrex-field">
                  ...
                  <select
                    className="altrex-input altrex-select"
                    {...form.register("item_parent_category")}
                  >
                ...
                <div style={{ display: "grid", gap: "12px" }}>
                  ...
                  <label className="altrex-field">
                    ...
                    <input
                      ...
                      className="altrex-input"
                      placeholder="10"
                      {...form.register("sales_convert_qty")}
                    />
                  </label>
                  <label className="altrex-field">
                  ...
                  <label className="altrex-field">
                    ...
                    <select
                      className="altrex-input altrex-select"
                      {...form.register("sales_currency_id")}
                    >
                      ...
                      {currencies.map((c: any) => {
                        ...
                        return (
                          <option key={id} value={String(id)}>
                            {c.currency_code ?? c.currencyCode ?? c.name} (
                            {c.symbol ?? "₹"})
                          </option>
                        );
                      })}
                ...
                <div style={{ display: "grid", gap: "12px" }}>
                  ...
                  <label className="altrex-field">
                    ...
                    <input
                      ...
                      className="altrex-input"
                      placeholder="10"
                      {...form.register("purchase_convert_qty")}
                    />
                  </label>
                  <label className="altrex-field">
                  ...
                  <label className="altrex-field">
                    ...
                    <input
                      ...
                      className="altrex-input"
                      placeholder="0.00"
                      {...form.register("purchase_conv_rate")}
                    />
                  </label>
                  <label className="altrex-field">
                    ...
                    <select
                      className="altrex-input altrex-select"
                      {...form.register("purchase_currency_id")}
                    >
                      <option value="">Select Currency...</option>
                      {currencies.map((c: any) => {
                        const id = getRecordId(
                ...
                <label className="altrex-field">
                  ...
                  >
                    ...
                    {taxes.map((t: any) => {
                      ...
                      return (
                        <option key={id} value={String(id)}>
                          {t.tax_name ?? t.taxName ?? t.name} (
                          {t.tax_percentage ?? t.percentage}
                          {suffix})
                        </option>
                      );
                    })}
