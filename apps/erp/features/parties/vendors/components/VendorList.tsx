...
export function VendorList() {
  ...
  const [selectedVendor, setSelectedVendor] = useState<PartyRecord | null>(
    null,
  );
          ...
          <div className="altrex-stat-value">
            {vendors.reduce(
              (acc: number, v: PartyRecord) =>
                acc +
                (v.addresses?.length || v.tbl_party_addresses?.length || 0),
              0,
            )}
          </div>
                  ...
                  >
                    ...
                    <p style={{ margin: "4px 0 14px", fontSize: 12 }}>
                      {searchQuery
                        ...
                        : "Start by registering your first supplier."}
                    </p>
                    {!searchQuery && (
                      <button
                        type="button"
      ...
      {deleteId && (
        ...
        >
          ...
          >
            ...
            >
              Are you sure you want to remove this vendor? The record will be
              deactivated from the directory.
            </p>
            <div
